...
async function getAndDeleteNumbers(totalNeeded) {
  ...
  // Ambil semua rows (pastikan sheet tidak super besar, kalau besar nanti aku bikin versi pagination)
  ...
  // Hapus dari belakang biar index aman
...
// ===== RUN =====
bot.launch().then(() => {
  console.log("🟢 VCARD BOT BERJALAN (NODE + RENDER READY)");
});
